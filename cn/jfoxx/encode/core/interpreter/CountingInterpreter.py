from cn.jfoxx.encode import UniqueInterpreter


class CountingInterpreter(UniqueInterpreter):
    def __init__(self, dimensions: list, encode_dimensions: list, feature_dimensions=None, counting_dimension=None):
        """
        数据识别
        :param dimensions:保留维度
