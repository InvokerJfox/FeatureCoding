...
class MappingOneHotEncoder:
    ...
    @staticmethod
    def expand(older: MappingOneHotCoder, dimensions: list, start_key="from", target_key="to") -> MappingOneHotCoder:
        """
        对编码器追加特征
        :param older: 旧编码器
    ...
    @staticmethod
    def coder(passport: str, dimensions: list, start_key="from", target_key="to") -> MappingOneHotCoder:
        """
        通过特征生成一个映射型独热编码器
        ...
        :return:
        """
        coder = MappingOneHotCoder(passport, [], dict())
        return MappingOneHotEncoder.expand(coder, dimensions, start_key, target_key)
